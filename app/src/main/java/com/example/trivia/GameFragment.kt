...
//            setText(R.string.hello_blank_fragment)
        val binding: FragmentGameBinding = DataBindingUtil.inflate<FragmentGameBinding>(
            inflater,
        ...
        // Bind this fragment class to the layout variable "game"
        binding.game = this

        //setOnClickListener to the button
        binding.submitButton.setOnClickListener { vista ->
